...
import './ViewStdAttendance.css'; // Import CSS file
...
const ViewStdAttendance = () => {
  ...
  const renderTableSection = () => (
    <div className="attendance-container">
      <Typography variant="h4" align="center" gutterBottom className="attendance-title">
        Attendance
      </Typography>
      ...
      <Typography variant="subtitle1" className="overall-percentage">
