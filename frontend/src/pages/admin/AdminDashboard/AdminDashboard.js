...
const AdminDashboard = () => {
  ...
  return (
    <div className="admin-dashboard-container">
      <CssBaseline />
      <AppBar className={`admin-appbar ${open ? 'open' : ''}`} position='absolute'>
        <Toolbar className="toolbar-style">
          ...
          <Typography component="h1" variant="h6" color="inherit" noWrap className="appbar-title">
            Admin Dashboard
          </Typography>
          <AccountMenu />
        </Toolbar>
      ...
      <Drawer variant="permanent" className={open ? 'drawer-open' : 'drawer-close'}>
        <Toolbar className="toolbar-style">
